...
class HockeyScoreActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_hockey_score)
        ...
        val result = intent.getIntExtra("current_hockey",0)
        val sharedPreferences = getSharedPreferences("my_preferences", Context.MODE_PRIVATE)
        val max = sharedPreferences.getInt("max_hockey", 0)
